      ...
      // ============================================
      console.log('🚀 West EPCM Technologies v1.0.3-final loaded at:', new Date().toISOString());
            ...
            bannerContent = `
                ...
                ">
                    ...
                    <div style="display: flex; align-items: flex-start; gap: 1rem;">
                        ...
                        <div style="flex: 1;">
                            <strong style="font-size: 1.1rem;">Install West EPCM Technologies App</strong>
            ...
            bannerContent = `
                ...
                ">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.75rem; flex: 1;">
                        ...
                        <div>
                            <strong>Install West EPCM Technologies</strong>
        ...
        async function renderDashboard(data) {
            ...
            document.getElementById('mainContent').innerHTML = `
                <div class="page-header">
                    <h2>Dashboard</h2>
                    <div class="subtitle">Welcome to West EPCM Technologies — Project Management Tool</div>
                </div>
                ${announcementsHtml}
                ...
                return `
                    <div class="announcement-card company-news news-priority-${announcement.priority || 'low'}" style="${cardBaseStyle} border-top: 5px solid #3b82f6;">
                        ...
                        <div class="announcement-footer" style="padding: 0.5rem 1rem; background: #f9fafb; border-top: 1px solid #e5e7eb; display: flex; justify-content: space-between; align-items: center; font-size: 0.7rem;">
                            ...
                            <span style="color: #667eea; font-weight: 600;">West EPCM Technologies HR</span>
                        </div>
                    </div>
                `;
            }
            ...
            overlay.innerHTML = `
                <div class="news-modal-card">
                    ...
                    <div class="news-modal-footer">
                        ...
                        <span class="news-modal-brand">West EPCM Technologies HR</span>
                    </div>
                </div>
            `;
