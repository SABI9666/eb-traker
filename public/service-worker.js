...
// Version: 5.0.0 - Cache Version 35 (Training & Sample Hours Feature)
// ============================================
      ...
      .then((clients) => {
        ...
        clients.forEach(client => {
          client.postMessage({ 
            type: 'CACHE_UPDATED',
            version: 'v35',
            message: 'New version available with Training & Sample Hours Feature! Please refresh.'
          });
        });
      })
  );
...
console.log('✅ Service Worker v35: Loaded successfully - Training & Sample Hours Feature enabled');
